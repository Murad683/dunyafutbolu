    ...
    api
      ...
      .then((res) => {
        if (!cancelled && res.data.length > 0) {
          setTransfers(res.data.map(toTransfer));
        }
      })
      .catch(() => {
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 text-sm text-text-secondary mb-1">
                          <div className="flex items-center gap-1.5 min-w-0">
                            {t.fromClubLogo ? (
                              <img src={t.fromClubLogo} alt={t.fromClub} className="w-4 h-4 object-contain" />
                            ) : (
                          ...
                          <div className="flex items-center gap-1.5 min-w-0">
                            {t.toClubLogo ? (
                              <img src={t.toClubLogo} alt={t.toClub} className="w-4 h-4 object-contain" />
                            ) : (
                              <Shield size={14} className="text-text-muted" aria-hidden />
                            )}
